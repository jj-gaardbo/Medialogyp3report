\chapter{Analysis}
    ...
    \section{State of the art}\label{sec:SOTA}
		\subsection{AlohaVR}
			AlohaVR by One Caring team is an immersive virtual reality application designed to seize the physiological issues elders could be having in their age. Instead of using pharmaceutical solutions to take away pain, anxiety, issues with relaxation etc. the product takes a neurological approach to solve the potential issues. They created immersive virtual reality landscapes, with the purpose to bring happiness and good memories to life for the elders whilst escaping their reality, which includes the aforementioned issues. One Caring team have monitored some of their users, to research how their virtual reality worlds affects the brain of the user, to further develop and create more effective experiences for the users.
		
		\subsection{Other vr applications}
		
		\subsection{Sketching}
		 \subsubsection{Mental Canvas}
			A software system that combines 2D draw-and-paint with 3D which enables a user to quickly create a 3D environment from sketches.\cite{sotaMentalCanvas} It has been created for Microsoft's Surface technologies\footnote{Microsoft Surface: \url{https://www.microsoft.com/en-us/surface}} and is compatible with the Surface Dial.%todo: Write some more text about this
