\chapter{Analysis}
	...
	It has been established that green spaces, like residential gardens or public parks or forests, provide ecosystem service benefits and have an impact on our psychological well-being and physical well-being as they promote physical activity\cite{urbanGreenSpace}. Although the urban public in cities, might not have private access to a yard of their own, and might therefore be forced to make use of the public green spaces, they still get the ecosystem service benefits from surrounding private yards\cite{greenSpaceBenefits}\todo{More stuff from these sources here}\cite{healthBenefitsNature}.
...
\begin{comment}
	...
	\section{Technologies}\label{sec:technologies}			
		...
		Virtual reality allows for early and precise visualisations of conceptual designs, which could be for any sort of profession e.g. architecture, plumbing, carpentry and the like. Besides conceptual design, it has also been used for manufacturing planning where one could track the process of assembling objects, machines etc. to plan what effort goes into the process of manufacturing. It can be understood as a Computer Aided Design (CAD) software, but as mentioned in \cite{engineeringVR} with the immersive feel. This means that the user actually activates and uses several human senses in the process of any of the aforementioned situations.	
    ...
    \section{State of the art}\label{sec:SOTA}
		...
		\subsection{Invita kitchen VR}
			...
			To get an idea of how it works, and how the interior designers make this happen, one must make an appointment with their designers before it is possible to see the process and outcome.
