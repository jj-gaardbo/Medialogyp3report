		...
		\subsection{Reactable}
			...
			%Some design requirements.
				\subsection{Functional requirements}
					...
					\begin{itemize}
						%Target Group
						\item[-] The product should be aimed at landscape architects in their design process
						\item[-] The product should be able to visualize a conceptual design of a garden in a 3D Virtual Environment
						...
						%Design
						\item[-] It should be easy to do alterations, add and remove objects to the virtual representation of the proposed garden.
				...
				\subsection{Non-functional requirements}
					...
					\begin{itemize}
						...
						\item[-] Virtual garden should support garden sizes under 50 m$^2$ and up to 1600 m$^2$. \todo{Conclude that this was not done due to timeconstraints and the limitiations of the physical models construction}
						...
						%Markers
						\item[-] The program should implement computer-vision, and translate marker data into a 3D Virtual using Image Processing
