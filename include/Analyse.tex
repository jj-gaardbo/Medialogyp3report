			...
			%Some design requirements.
				...
				\subsection{Non-functional requirements}
					...
					\begin{itemize}
						...
						\item[-] The application should include the most common plants found in a Danish garden (See \autoref{sec:initialSurvey}):
						\begin{itemize}
							\item[-] Roses
							\item[-] Rhododendron
							\item[-] Apple trees
						...
						\item[-] Virtual garden should support garden sizes under 50 m$^2$ and up to 1600 m$^2$.(See \autoref{sec:initialSurvey}) \todo{Conclude that this was not done due to timeconstraints and the limitiations of the physical models construction}
