    ...
    \section{State of the art}\label{sec:SOTA}
		...
		\subsection{Sketching}
		 \subsubsection{Mental Canvas}
			A software system that combines 2D draw-and-paint with 3D which enables a user to quickly create a 3D environment from sketches. %todo: Write some more text about this
