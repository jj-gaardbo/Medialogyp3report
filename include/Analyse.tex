...
\begin{comment}
	...
	\subsection{Expert Interviews}\label{sec:expertInterviews}
		...
		In this sub section the main categories from the previously mentioned coding process will be examined. The list of categories is listed below:
		\begin{enumerate}
			\item Clients
			\item Design
			\item Technologies
		...
		\paragraph*{Clients}
		The experts were all asked about their clients and what kind of people they would usually work with. One thing they all had in common was that they would primarily work with private clients. Here are some of the statements from the experts.
