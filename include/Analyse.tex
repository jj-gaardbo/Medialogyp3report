\chapter{Analysis}
	...
	\section{Verification of problem}\label{sec:verification}
 	...
 	\subsection{Benefits of Green Space}
	It has been established that green space plays an important role in peoples psychological well-being and the ecosystem, whether we are talking about a residential garden or urban green space like parks and forests\cite{urbanGreenSpace}\cite{greenSpaceBenefits}\cite{healthBenefitsNature}.
...
>>>>>>> 494f28c0259456b09be8087002e800750f3993be
...
<<<<<<< HEAD
						...
						\item Virtual garden should support garden sizes under 50 m$^2$ and up to 1600 m$^2$.\todo{What's feasible when considering size of tokens and size of acrylic surface?}
=======
						\begin{comment}
