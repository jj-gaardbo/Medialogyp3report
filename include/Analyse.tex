	...
	\section{Technologies}\label{sec:technologies}
		\subsection{Virtual Reality}
			...
			\subsection{Fiducial markers}
				...
				It is important to state here, that not every kind of pattern in a marker is suitable when it comes to fiducial markers. As an example it is worth mentioning bar codes, these are not suitable as fiducial markers, because they are made to be read by a laser scanner.\\\\
