\chapter{Analysis}
	...
	\section{Verification of problem}\label{sec:verification}
		In order to narrow down the scale of the problem area, an initial brainstorm session was done. This session concluded with the following mind-map (\autoref{fig:brainstorm})\\
		\begin{figure}[H]
		\centering
			\begin{tikzpicture}
