...
The post-test interview will start with \todo{add questions}
...
\subsubsection{Strategy for observation}
\todo{what's out research question? "How to improve the garden design process?" Or is it "How to help visualize the newly designed garden for the client"?}
