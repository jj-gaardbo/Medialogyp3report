...
\section*{Validity}
	...
	\end{quote}
	What this roughly means is that how much the data can be trusted, if the there can be potential variations that might invalidate the data. Some potential causes for and against the validity of our two tests could be:\\
	\begin{enumerate}
