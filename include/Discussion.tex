...
\section*{Validity}
	...
	\begin{enumerate}
		...
		\item For the usability test, all of the participants were Medialogy students. This might have skewed their responses, due to them attending the same study as us.\\
		
		\item For the immersion test, the participants where convenience sampled from various group rooms around campus, in the most likely case all were students at AAU CPH. This might have made them respond differently than they would have done if we weren't also students at AAU CPH.\\
