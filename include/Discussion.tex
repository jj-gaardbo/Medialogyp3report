...
\section*{Validity}
	...
	\begin{enumerate}
		...
		\item For the usability test, all of the participants were Medialogy students.\\
		
		\item For the immersion test, the participants where convenience sampled from various group rooms around campus, in the most likely case all were students at AAU CPH.
