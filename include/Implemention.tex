...
\end{listing}
From these, the sample points can be acquired and the program can check whether the bit fields that they point to are dark or white. This is done by checking each color in the original image and, if they all are below a threshold, adding 2 to the power of the field to the total count\todo{Explain what is the total count}. The implementation can be seen in Listing \ref{listing:sumingval}.
 \begin{listing}[H]
...
\todo{Add short section on how the Unity environment is set up}