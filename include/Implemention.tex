...
For this reason the algorithm should be fairly quick to execute, because there is going to be quite a load on the system running the VR experience. Consequently, we have been trying to optimize our algorithm.
