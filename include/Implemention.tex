...
Because RG can be represented by two values it is possible to plot the  chromaticity space using two axes, as can be seen in figure \ref{fig:rgbNorm}. The image contains a slightly modified 
\begin{figure}[H]
	\centering
...
\todo{Intoduce gridSIze and the non recurrsive version}
