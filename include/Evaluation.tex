...
After the participants tried their different roles they where asked to fill out a questionnaire (see appendix ??)\todo{put it in} as their respective roles, so each participant had to fill out two questionnaires. The questionnaires contained questions regarding the experience as a client and an architect.
...
\subsection*{Was it easy to follow the client's instructions?}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth]{figure/Evaluation/pie1.png}
	\caption{Pie chart showing visualizing if the participants found it easy to follow the client's instructions.}
	\label{fig:pie2}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth]{figure/Evaluation/pie3.png}
	\caption{Pie chart showing visualizing whether or not the program responded accurately to the participants' actions.}
	\label{fig:pie3}
\end{figure}
