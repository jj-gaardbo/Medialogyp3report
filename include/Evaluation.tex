...
In addition to this question the participants was able to give a comment, if they answered no to the given question, here are some examples of the answers:\\

Would like more trees :)\\
It bugged out, so at first there were nothing showing so i could not do anything per say?\\
I had a hard time knowing where the client was on the glass plate compared to the items. Sometimes there were some consistency in where i placed the item and where it appeared, but i got the hang of it eventually\\
orientation is very difficult to understand\\
