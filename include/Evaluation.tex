...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\linewidth]{figure/Evaluation/pie1.png}
	\caption{}
	\label{fig:pie1}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\linewidth]{figure/Evaluation/pie2.png}
	\caption{.}
	\label{fig:pie2}
\end{figure}

\subsection*{Did the program respond accurately to your actions?}
As it can be seen in \ref{fig:pie3}, half of the participants stated that the program responded accurately to their actions and half of them stated that this was not the case.

\begin{figure}[H]
	\centering
	\includegraphics[width=1\linewidth]{figure/Evaluation/pie3.png}
	\caption{.}
	\label{fig:pie3}
\end{figure}
