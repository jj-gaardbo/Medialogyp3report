...
\end{itemize}
The laptop running the VR unit, are according to HTC's own minimum specification requirements, not powerful enough to run a virtual environment smoothly\footnote{\href{Vive recommended specifications for Virtual Reality}{https://www.vive.com/us/ready/}}.
