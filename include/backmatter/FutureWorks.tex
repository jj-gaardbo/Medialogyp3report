...
<<<<<<< fd90b8c0a99822599ad5b71116362b1f1dc25686
...
=======
\textbf{Knowing where the client is in the garden, while the architect is building it.} In addition to this some kind of marker could be installed to track where the client was in the VR world and that would show op on the glass plate for the architect to know exactly where the client was at that moment. This could probably be achieved by using a laser pointer attached to a motor. To which degree how easy or difficult this would be to install is not considered yet, but it needs to be efficient and not slowing down the system or being more cumbersome than necessary. If that is the case however, its considered that a projector system is needed.\\
>>>>>>> changes and some future
